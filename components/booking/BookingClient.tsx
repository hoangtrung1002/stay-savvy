...
const BookingClient = () => {
  ...
  const [payLoaded, setPayLoaded] = useState<boolean>(false);
  ...
  if (payLoaded && !isPaymentSuccess && (!bookingRoomData || !clientSecret))
    return (
      <div className="flex items-center flex-col gap-4">
        <div className="text-rose-500">
          Oops! This page could not be property loaded...
        </div>
    ...
    <div className="max-w-[700px] mx-auto">
      {clientSecret && bookingRoomData && (
        <div>
          ...
          <Elements options={options} stripe={stripPromise}>
            <RoomPaymentForm
